...
5. For handoffs, require both the explicit path and expected SHA-256. See
   `docs/HANDOFF_TEMPLATE.md` "TruthDeck boundary snapshot" for the exact
   create/receive commands and `truthdeck_verify_handoff` for the MCP form.
