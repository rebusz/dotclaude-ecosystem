...
- R1 `auditf.py` gets Kimi 3 through the Perplexity CDP picker; R2/R3 `fuse.py` and coding/repository-review tasks use Kimi CLI. The dedicated Kimi CDP lane is not a workflow lane.
